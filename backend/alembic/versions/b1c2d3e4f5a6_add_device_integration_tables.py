...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("adjusted_pace_sec_per_km", sa.Float),
    ...
    op.create_table(
        ...
        sa.Column("hrv_baseline_ms", sa.Float),
        sa.Column("hrv_status", sa.Text),
        sa.Column("training_load_short", sa.Float),
        sa.Column("training_load_long", sa.Float),
        sa.Column("load_ratio", sa.Float),

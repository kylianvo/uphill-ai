...
export const LANDING_FEATURES: FeatureContent[] = [
  {
    ...
    vi: {
      ...
      personalizedNote: "Xây dựng từ ngưỡng thể lực, tiền sử chấn thương và khối lượng tập hiện tại.",
  ...
  },
  {
    ...
    vi: {
      ...
      personalizedNote: "Dùng giáo án đang hoạt động và hồ sơ chạy bộ của bạn.",
  ...
  },
  {
    ...
    vi: {
      ...
      personalizedNote: "Dùng lịch sử pace/giải đấu của bạn và hồ sơ chính xác cung đường mục tiêu.",
  ...
  },
  {
    ...
    vi: {
      ...
      personalizedNote: "Dùng cân nặng, file GPX cung đường và thời tiết thật ngày thi đấu của bạn.",
  ...
  },
  {
    ...
    vi: {
      ...
      personalizedNote: "Dùng sở thích form giày, ngân sách và địa hình giải đã match của bạn.",
  ...
  },
  {
    ...
    vi: {
      ...
      personalizedNote: "Dùng cự ly giải, thời tiết dự kiến và bối cảnh giáo án đang hoạt động của bạn.",

...
export default function AppPage() {
  ...
  const handleCompleteOnboarding = async () => {
    ...
    try {
      ...
      // Close onboarding and let user into the app right away. setActiveTab
      // (not handleTabSwitch) because handleTabSwitch's chat/planner gate
      // reads `user` from this closure, which still holds the pre-onboarding
      // (unauthenticated) value here -- it would wrongly reopen AuthModal.
      setOnboardingOpen(false);
                  ...
                  style={{
                    ...
                    padding:
                      activeTab === "chat" && isViewportMobile
                        ? "0px"
                        : undefined,
                    paddingBottom: isViewportMobile
                      ? activeTab === "chat"
